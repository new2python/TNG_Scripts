...
def update_workbook():
	...
	filename = "L:\\Merge and Print\\Customer_Documents.xlsx"
...
wb = openpyxl.load_workbook("L:\\Merge and Print\\Customer_Documents.xlsx")
sheet = wb.active
...
for i in range(2,sheet.max_row+1):
	...
	#TO DO --- Change command to incorporate os.path.join()
...
try:
	os.remove("L:\\Merge and Print\\Script_Running.txt")
except:
